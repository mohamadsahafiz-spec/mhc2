...
export const themePalettes: Record<NamedTheme, ThemeColorPalette> = {
  ...
  lumen: {
    ...
    shadow: 'inset 0 1px 0 0 rgba(255, 255, 255, 0.12), 0 16px 36px -6px rgba(0, 0, 0, 0.8)',
    ...
    atmosphere: {
      canvasBg: 'linear-gradient(to right, rgba(255, 255, 255, 0.018) 1px, transparent 1px), linear-gradient(to bottom, rgba(255, 255, 255, 0.018) 1px, transparent 1px), radial-gradient(1100px 500px at 50% -60px, rgba(35, 48, 72, 0.45) 0%, rgba(14, 22, 34, 0.2) 60%, transparent 100%), radial-gradient(1300px 600px at 50% calc(100% + 100px), rgba(30, 45, 68, 0.25) 0%, transparent 70%), #07080A',
      backdrop: 'blur(14px)',
      shadowCard: 'inset 0 1px 0 0 rgba(255, 255, 255, 0.12), 0 16px 36px -6px rgba(0, 0, 0, 0.8)',
